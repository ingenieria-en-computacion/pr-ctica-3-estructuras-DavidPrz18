#include "conjunto.h"
#include <stdio.h> 
// #include <conjunto.h> de esta manera NO porque esas son para las bibliotecas propias del compilador
//se copian directamente del conjunto.h
